            ...
            return(
                <div className="componentHome">
                                ...
                                <div className="componentHomeFooterLittleDevice">
                                   ...
                                   <br/><br/><br/>
                                   <p className="componentObligation">campo obrigatório *</p>
                                    <input className="componentHomeInputLittleDeviceName" type="text" placeholder="insira seu nome:"/>
                                    <input className="componentHomeInputLittleDeviceEmail" type="text" placeholder="insira seu email *:"/>
                                    <button className="componentButtonFooterLittleDeviceEnviar">enviar</button>
